CREATE TABLE CategoriasItens (
 id_categoria_item RAW(32) DEFAULT sys_guid() NOT NULL,
 nome VARCHAR(30) NOT NULL,
 subtipo RAW(32)
);

ALTER TABLE CategoriasItens ADD CONSTRAINT PK_CategoriasItens PRIMARY KEY (id_categoria_item);


CREATE TABLE Itens (
 id_item RAW(32) DEFAULT sys_guid() NOT NULL,
 id_categoria_item RAW(32) NOT NULL,
 nome VARCHAR(30) NOT NULL,
...
CREATE TABLE Enderecos (
 ...
 id_tipo_endereco RAW(32) NOT NULL,
 id_cliente RAW(32) NOT NULL,
...
CREATE TABLE ContasBancarias (
 id_conta_bancaria RAW(32) DEFAULT sys_guid() NOT NULL,
 id_entregador RAW(32) NOT NULL,
...
CREATE TABLE Pedidos (
 ...
 situacao VARCHAR(15) DEFAULT 'Aguardando'
);
...
CREATE TABLE Repasses (
 ...
 id_entrega RAW(32) NOT NULL,
 id_conta_bancaria RAW(32) NOT NULL,
